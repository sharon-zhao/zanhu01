...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///zanhu01")
}
...
EMAIL_HOST_PASSWORD = "fvcrgbylbjtnbceb"
...
ADMINS = [("""__Sharon__""", "__sharon__@example.com")]
...
CELERY_TASK_SERIALIZER = "msgpack" # msgpack是比json数据结构更小更快的方式
